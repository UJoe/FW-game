function initGame() {
  ...
  let rooms = [
    ...
    },
    {
      ...
      question: "Ha a felhasználó rákeres egy kifejezésre egy webhelyen, melyik tag-gel jelölhetjük az egyezőséget a találati listában?",
  ...
  function newRoom() {
    ...
    if (rooms[room].type === "attack") {
      ...
      `;
      //ellenfél értékei
      char[1].hp = parseInt(step / 1.2 + rooms[room].values[0] * 20 + Math.random() * 30);
      changeVal(1, 1, char[1].hp);
      char[1].att = parseInt(step / 1.2 + rooms[room].values[1] * 20 + Math.random() * 30);
      changeVal(1, 2, char[1].att);
      char[1].def = parseInt(step / 1.2 + rooms[room].values[2] * 20 + Math.random() * 30);
      changeVal(1, 3, char[1].def);
      char[1].mAtt = parseInt(step / 1.2 + rooms[room].values[3] * 20 + Math.random() * 30);
      changeVal(1, 4, char[1].mAtt);
      char[1].mDef = parseInt(step / 1.2 + rooms[room].values[4] * 20 + Math.random() * 30);
      ...
      document.getElementById("attackBtn").addEventListener("click", function () {
        ...
        document.getElementById("nmePhoto").classList.remove("nmeAttackClass");
        ...
        if (char[0].hp < 1) {
          ...
          setTimeout(function () {
            ...
            document.getElementById("newGameBtn").addEventListener("click", function () {
              ...
              consoleArray = ["<br><br>Nyújtózol egyet sikeres feltámadásod után..."];
              newRoom();
            })
          }, 2501)
        }
  ...
  function message(text) {
    ...
    if (rooms[room].type === "attack") { document.getElementById("consoleText").innerHTML = consoleArray };
